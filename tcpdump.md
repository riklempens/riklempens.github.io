...
In binary: `tcpdump -i eth1 'ip[0] & 15 > 5'`
In hexadecimal: `tcpdump -i eth1 'ip[0] & 0xf > 5'`
...
character following the GET command (a space) "GET " in hex : 47455420`
...
From: Sake Blok [sake@xxxxxxxxxx](mailto:sake@xxxxxxxxxx)
